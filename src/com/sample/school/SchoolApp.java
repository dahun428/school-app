	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if(menuNum == 1) {
				...
				System.out.println("=================================================================================");
				System.out.println("1.신규등록 2.수강관리 3.과목조회 4.개인정보조회");
				System.out.println("=================================================================================");
				...
				if(StudentMenuNum == 1) {
					...
					System.out.println("=================================================================================");
					System.out.println("1.수강신청 2.수강취소 3.수강조회 4.현재 열린강좌 5.점수조회");
					System.out.println("=================================================================================");
					System.out.print("메뉴 입력 : ");
					...
					if(myMenuNum == 1) {
						...
						System.out.println("=================================================================================");
						service.retrieveCourseByStudent(studentNo);

						System.out.print("수강신청한 강좌 번호를 입력하세요 :  ");
						int courseNo = SchoolApp.nextInt();
						service.registrateCourse(studentNo, courseNo);
					...
					service.retrieveSubjectByStudentNo(studentNo);
				...
				if(professorMenuNum == 1) {
					...
					System.out.println("=================================================================================");
					System.out.println("개설과정번호	학생번호	학생이름	학년	학과	학생이메일	취소여부	현재성적");
					System.out.println("=================================================================================");				
					System.out.println();
